...
expected ground-truth documents, parents, and child hits. Evaluated against real
administrative decisions from Đài Tiếng nói Việt Nam (VOV) in data/QuyetDinh.
Includes multi-document cross-file queries, leadership signatory tracking,
budget table extraction, and domain-wide thematic synthesis.
"""
