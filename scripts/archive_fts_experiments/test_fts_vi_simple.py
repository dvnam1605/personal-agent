...
async def main():
    ...
    try:
        ...
        ''',
            document_id, document_id, None, 1, 'test', 'test-id', 'Test Document for FTS VI', 'http://test', 'text/plain', None, 'active', True, '{}', now, now)
        ...
        for s in sentences:
            ...
            ''',
                ...
                None, None, '{}', now)  # Note: we set provenance_uri to NULL since the column exists but we don't have a test value; we can leave it NULL.
